<template>
    <div class="mapcharts3" id="mapcharts3">
        <div class="map" ref="chinaMap2" id="chinaMap2"></div>
    </div>
</template>
...
export default {
    ...
    methods:{
        init() {
            this.myChart = echarts.init(this.$refs.chinaMap2);
            var geoCoordMap = {
                '上海': [121.4648, 31.2891],
                '东莞': [113.8953, 22.901],
                '东营': [118.7073, 37.5513],
            ...
            var BgData = this.BgData
            let bgcData= this.bgcData
            ...
            var series = [
                // 省份颜色
                {
                    ...
                    left: 'center',
                    align: 'right',
                    label: optionData.upperlabel,
                    itemStyle: optionData.upperItemStyle,
                    data: bgcData
                }
            ];
            BgData.forEach(function(item, i) {
                series.push(
                    {
                        type: "effectScatter",
            ...
            let option = {
                ...
                backgroundColor: optionData.backgroundColor,
                visualMap: optionData.visualMap,
                geo: [
                    {
                        map: 'china',
                        zoom: 1.2,
